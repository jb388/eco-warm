#' Check core template file format
#'
#' @description Check that core template files (experiment, site, plot)match with the corresponding meta data files (expMeta, sitMeta, pltMeta)
...
#' @examples
#' checkCoreFormat()
checkCoreFormat <- function(outfile = "", verbose = TRUE) {
